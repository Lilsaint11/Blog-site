...
const Footer = () => {
    return ( 
        <div className="footer-container">
            ...
            <span  className="foot footer-links">
                <div>
                    <div>
                        <h3>Footer Links</h3>
            ...
            <p className="copyright">Copyright {new Date().getFullYear()}. All Rights Reserved. - Designed  by &nbsp;<a href="https://stephen-portfolio-lilsaint11.vercel.app"> Stevetech.co </a>
            </p>
        </div>
     );
}
